package com.rakesh.cards.controller;

import com.rakesh.cards.constants.CardsConstants;
import com.rakesh.cards.dto.CardsContactInfoDto;
import com.rakesh.cards.dto.CardsDto;
import com.rakesh.cards.dto.ErrorResponseDto;
import com.rakesh.cards.dto.ResponseDto;
import com.rakesh.cards.service.ICardsService;
 ...
 */
@Tag(
    name = "CRUD REST APIs for Cards in Rakesh Bank",
    description = "CRUD REST APIs in Rakesh Bank to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
@RequestMapping(
    path = "/api",
...
public class CardsController {
  ...
  @Autowired private CardsContactInfoDto cardsContactInfoDto;
  ...
  @Operation(
      ...
      description = "REST API to create new Card inside Rakesh Bank",
      responses = {
