...
/*This interface is created so that we can communicate with the loans microservice from our service,
...
public interface LoansFeignClient {
  ...
  So behind the scenes, my loans FeignClient will connect with the Eureka Server and try to fetch
  all the instances that are registered with the logical name loans. And once it receives 1 or 2
